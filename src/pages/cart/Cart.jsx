...
import { removeFromCart, increaseQuantity, decreaseQuantity } from '../../redux/cartSlice'; // Import actions
...
function Cart() {
  ...
  const shipping = 20; // Static shipping cost or can be dynamic
        ...
        <div className="mx-auto max-w-5xl justify-center px-6 md:flex md:space-x-6 xl:px-0">
          ...
          <div className="rounded-lg md:w-2/3">
            {cartItems.map((item, index) => (
              <div key={index} className="mb-6 rounded-lg border drop-shadow-xl bg-white p-6 sm:flex sm:justify-start" style={{ backgroundColor: mode === 'dark' ? 'rgb(32 33 34)' : '', color: mode === 'dark' ? 'white' : '', }}>
          ...
          <div className="mt-6 h-full rounded-lg border bg-white p-6 shadow-md md:mt-0 md:w-1/3" style={{ backgroundColor: mode === 'dark' ? 'rgb(32 33 34)' : '', color: mode === 'dark' ? 'white' : '', }}>
            <div className="mb-2 flex justify-between">
              ...
              <p className="text-gray-700" style={{ color: mode === 'dark' ? 'white' : '' }}>₹{totalPrice}</p>
            </div>
            ...
            <div className="flex justify-between mb-3">
              ...
              <div>
                <p className="mb-1 text-lg font-bold" style={{ color: mode === 'dark' ? 'white' : '' }}>₹{totalPrice + shipping}</p>
              </div>
            </div>
            <p className="text-center text-gray-400 mt-4">
              <Link to="/Model" className="text-blue-400 hover:underline">
                BUY NOW
              </Link>
            </p>
          </div>
